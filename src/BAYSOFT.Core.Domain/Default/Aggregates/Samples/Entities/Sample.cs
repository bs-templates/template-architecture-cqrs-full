...
{
    // <forge:entity context="Default" name="Sample" aggregateRoot="true" auditable="true">
    ...
    {
        #region Attributes
        // <forge:property entity="Sample" name="Description" type="string" required="true" length="128">
