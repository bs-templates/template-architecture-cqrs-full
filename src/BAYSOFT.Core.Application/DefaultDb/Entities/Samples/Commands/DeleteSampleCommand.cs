...
namespace BAYSOFT.Core.Application.DefaultDb.Entities.Samples.Commands
{
    ...
    public sealed class DeleteSampleCommandResponse : ApplicationResponse<Sample>
    {
    ...
    public sealed class DeleteSampleCommandHandler : ApplicationRequestHandler<Sample, DeleteSampleCommand, DeleteSampleCommandResponse>
    {
