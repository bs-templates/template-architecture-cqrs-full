...
namespace BAYSOFT.Core.Application.DefaultDb.Entities.Samples.Commands
{
    ...
    public sealed class PatchSampleCommandResponse : ApplicationResponse<Sample>
    {
    ...
    public sealed class PatchSampleCommandHandler : ApplicationRequestHandler<Sample, PatchSampleCommand, PatchSampleCommandResponse>
    {
